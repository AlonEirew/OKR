class ResultObject:
    def __init__(self, word1_id, word1, word2_id, word2, syn_result, fuzzy_result, partial_result, wikidata_result):
    ...
    def to_string(self):
        return self.word1_id + ':' + self.word1 + ',' + self.word2_id + ':' + self.word2 + ',' + str(
